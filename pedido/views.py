...
class Pagar(DispatchLoginRequiredMixin, DetailView):
    ...
    #     if pedido.verificar_pagamento():
    #         # Pagamento concluído, redirecionar para a página de confirmação
    #         return redirect('pagamento-concluido')
...
class ConfirmarPagamento(DetailView):
    template_name = 'pedido/checarpag.html'
    model = Pedido
    pk_url_kwarg = 'pk'
    context_object_name = 'pedido'
